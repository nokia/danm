...
import (
	...
	danmv1 "nokia.net/crd/apis/danm/v1"
	danmclientset "nokia.net/crd/client/clientset/versioned"
	danmscheme "nokia.net/crd/client/clientset/versioned/scheme"
	danminformers "nokia.net/crd/client/informers/externalversions/danm/v1"
	danmlisters "nokia.net/crd/client/listers/danm/v1"
)
